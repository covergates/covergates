...
// Source: github.com/code-devel-cover/CodeCover/core (interfaces: UserService,UserStore)
...
func (m *MockUserService) Create(arg0 context.Context, arg1 core.SCMProvider) error {
	m.ctrl.T.Helper()
...
func (m *MockUserService) Find(arg0 context.Context, arg1 core.SCMProvider) (*core.User, error) {
	m.ctrl.T.Helper()
